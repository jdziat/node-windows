module.exports = {
    ...
    generateXml: function(config) {
        ...
        // Initial template
        var xml = '<service><id>' + config.id + '</id><name>' + config.name + '</name><description>' + config.description + '</description><executable>' + config.execPath + '</executable><arguments>' + config.flags + ' ' + config.script + '</arguments><logmode>' + config.logmode + '</logmode>';
